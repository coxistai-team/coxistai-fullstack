...
const NotesTopToolbar: React.FC<NotesTopToolbarProps> = ({
  ...
  return (
    <motion.div 
      className="bg-slate-900/50 backdrop-blur-xl border-b border-slate-700/50 p-3 sm:p-4"
    ...
    >
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2 sm:space-x-3">
          ...
          {/* Settings Button */}
          <motion.button
            className="p-1.5 sm:p-2 text-slate-400 hover:text-white hover:bg-slate-700/50 rounded-lg transition-all"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
          >
