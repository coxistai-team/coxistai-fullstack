...
import { useState } from "react";
import { motion } from "framer-motion";
import { MessageSquare, Users, Trophy, TrendingUp, Plus, Search, Filter, Clock, Heart, Share2, BookOpen, Star, Calendar, ThumbsUp, MessageCircle, Eye, Pin, Edit3, Trash2, Send } from "lucide-react";
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card";
import { Button } from "@/components/ui/button";
import { Input } from "@/components/ui/input";
import { Badge } from "@/components/ui/badge";
...
export default function Community() {
  ...
  const [posts, setPosts] = useState<Post[]>([
    {
      ...
      title: "Need help with calculus derivatives",
      content: "I'm struggling with understanding the chain rule. Can someone explain it in simple terms?",
      author: { id: "user1", name: "Sarah Chen", reputation: 125 },
      category: "Mathematics",
      tags: ["calculus", "derivatives", "help"],
      timestamp: "2 hours ago",
      likes: 8,
      ...
      comments: [
        {
          id: "c1",
          content: "The chain rule is used when you have a function inside another function. Think of it like peeling layers of an onion!",
          author: { id: "user2", name: "Alex Johnson" },
    ...
    },
    {
      ...
      title: "Study group for AP Physics - Starting Monday!",
      content: "Looking for serious students to join our AP Physics study group. We meet twice a week.",
      author: { id: "current_user", name: user?.firstName + " " + user?.lastName || "You", reputation: 89 },
      category: "Study Groups",
      tags: ["physics", "AP", "study-group"],
      timestamp: "4 hours ago",
      likes: 15,
    ...
    },
    {
      ...
      title: "Best strategies for SAT reading comprehension?",
      content: "I'm consistently scoring low on reading comp. What techniques have worked for you?",
      author: { id: "user3", name: "Emma Thompson", reputation: 67 },
      category: "Test Prep", 
      tags: ["SAT", "reading", "strategy"],
      timestamp: "6 hours ago",
      likes: 23,
  ...
  const handleEditPost = (postId: string, newTitle: string, newContent: string) => {
    setPosts(posts.map(post => {
      if (post.id === postId) {
                                    ...
                                    <>
                                      <Button
                                        ...
                                        onClick={() => {
                                          ...
                                          if (updatedPost) {
                                            handleEditPost(post.id, updatedPost.title, updatedPost.content);
                                          }
                                        }}
                                      >
                                        Save
                                    ...
                                    <div key={comment.id} className="flex items-start gap-3">
                                      ...
                                      <div className="flex-1 bg-gray-50 dark:bg-gray-800 rounded-lg p-3">
                                        <div className="flex items-center justify-between mb-1">
                                          ...
                                          {comment.author.id === "current_user" && (
                                            <Button
                                              variant="ghost"
                                              size="sm"
                                              onClick={() => {
                                                // Handle comment editing - only comment content, not username
