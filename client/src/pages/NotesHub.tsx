          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="lg:w-1/3 space-y-6">
              <div className="glassmorphism rounded-xl p-6 mb-6">
                <div className="mb-4 w-1/2 h-8 bg-gray-800 rounded animate-pulse"></div>
                <div className="mb-4 w-full h-10 bg-gray-800 rounded animate-pulse"></div>
                <div className="mb-2 w-full h-8 bg-gray-800 rounded animate-pulse"></div>
              </div>
            ...
            <div className="lg:w-2/3 space-y-6">
              <div className="h-12 w-2/3 mb-4 bg-gray-800 rounded animate-pulse"></div>
              <div className="h-8 w-1/3 mb-2 bg-gray-800 rounded animate-pulse"></div>
              ...
              <div className="space-y-3">
                {isNotesLoading ? (
                  ...
                  filteredNotes.map((note: Note, index: number) => (
                    <motion.div
                      key={note.id}
                      className={`glassmorphism-enhanced rounded-lg p-4 hover:bg-white/10 transition-all cursor-pointer hover-lift ${
                        selectedNote?.id === note.id ? 'border-l-4 border-blue-500 bg-blue-500/10' : ''
                      }`}
                      onClick={() => {
                          ...
                          {safeArray(note.tags).length > 0 && (
                            <div className="flex space-x-1 flex-wrap">
                              {safeArray(note.tags).map((tag: string) => (
                                                            <span 
                              key={tag}
                              className="px-2 py-1 rounded text-xs bg-blue-500/20 text-blue-400 flex items-center"
                            >
